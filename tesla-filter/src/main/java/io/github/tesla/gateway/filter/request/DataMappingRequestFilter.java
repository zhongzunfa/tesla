 ...
 */
public class DataMappingRequestFilter extends UserRequestFilter {
  ...
  public HttpResponse doFilter(NettyHttpServletRequest servletRequest, HttpObject httpObject) {
    ...
    if (userRule != null) {
      ...
      try {
        ...
        FilterUtil.writeFilterLog(DataMappingRequestFilter.class, tempalteContent + " is error ",
            e);
        return FilterUtil.createResponse(HttpResponseStatus.INTERNAL_SERVER_ERROR, nettyRequst,
            "DataMapping Error,the freemarker template is" + tempalteContent);
      }
    }
    return null;
  }
