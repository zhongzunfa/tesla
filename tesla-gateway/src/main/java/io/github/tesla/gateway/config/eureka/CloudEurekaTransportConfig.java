...
public class CloudEurekaTransportConfig implements EurekaTransportConfig {
  ...
  public int hashCode() {
    return Objects.hash(sessionedClientReconnectIntervalSeconds,
        retryableClientQuarantineRefreshPercentage, bootstrapResolverRefreshIntervalSeconds,
        applicationsResolverDataStalenessThresholdSeconds, asyncResolverRefreshIntervalMs,
        asyncResolverWarmUpTimeoutMs, asyncExecutorThreadPoolSize, readClusterVip, writeClusterVip,
        bootstrapResolverForQuery, bootstrapResolverStrategy, applicationsResolverUseIp);
  }
  ...
  public String toString() {
    return new StringBuilder("CloudEurekaTransportConfig{")
        ...
        .append("asyncResolverRefreshIntervalMs=").append(asyncResolverRefreshIntervalMs)
        .append(", ").append("asyncResolverWarmUpTimeoutMs=").append(asyncResolverWarmUpTimeoutMs)
        .append(", ").append("asyncExecutorThreadPoolSize=").append(asyncExecutorThreadPoolSize)
        .append(", ").append("readClusterVip='").append(readClusterVip).append("', ")
        ...
        .append("applicationsResolverUseIp=").append(applicationsResolverUseIp).append(", ")
        .append("}").toString();
  }
